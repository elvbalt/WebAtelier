...
describe('Task 2: Static Web Server', function() {
    ...
    it('GET /test-tiles.html should respond with 200, Content-Type: text/html', function(done) {
    ...
    it('GET /test-tiles.html should deliver the content of the corresponding file "public/test-tiles.html"', function(done) {
        ...
        request
            ...
            .end((err, res) => {
                if (err) done(err);
                    ...
                    fs.readFile(__dirname+"/../public/test-tiles.html", (err, data) => {
